...
namespace ConsoleApplication1.EmailServRef {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="FileAttachment", Namespace="http://schemas.datacontract.org/2004/07/Elektra.EmailServices")]
    ...
    public interface IMail {
        ...
        int SendEmail(string gmailUserAddress, string gmailUserPassword, string[] emailTo, string[] ccTo, string subject, string body, bool isBodyHtml, ConsoleApplication1.EmailServRef.FileAttachment[] attachments);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMailChannel : ConsoleApplication1.EmailServRef.IMail, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MailClient : System.ServiceModel.ClientBase<ConsoleApplication1.EmailServRef.IMail>, ConsoleApplication1.EmailServRef.IMail {
        ...
        public int SendEmail(string gmailUserAddress, string gmailUserPassword, string[] emailTo, string[] ccTo, string subject, string body, bool isBodyHtml, ConsoleApplication1.EmailServRef.FileAttachment[] attachments) {
